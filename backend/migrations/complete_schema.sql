-- Complete schema for Sulva Solutions Timetable Allocator
-- Combines initial schema and indexes, without unsupported CHECK subqueries
...
-- NOTE: The duration/timeslot consistency is enforced in the application code,
-- because Postgres CHECK constraints cannot contain subqueries.
